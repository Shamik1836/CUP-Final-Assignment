...
const registerUser = asyncHandler(async (req, res) => {
  const { name, email, password, isAdmin, isTA, isStudent } = req.body;
...
const updateUserProfile = asyncHandler(async (req, res) => {
  ...
  if (user) {
    ...
    user.isTA = req.body.isTA || user.isTA;
...
//@desc Get all students and teaching Assistants
//@route GET /api/users
